...
import type { RequestPermissionParams, RequestPermissionResult, StopReason } from "../acp/types.js";
...
export interface ApprovalEventHost {
    on(event: "approval/request", listener: (req: ApprovalRequestLike, next: () => Promise<ApprovalOutcome>) => Promise<ApprovalOutcome> | void): () => boolean;
}
/**
